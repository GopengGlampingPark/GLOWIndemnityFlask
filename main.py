...
def genbookid():
	if request.method == "POST":
		genbookid = generate_sequential_id("GLOWBOOKID_")
...
def health_emails(clientID):
	...
	msg = Message(
			...
			recipients=['operationglow22@gmail.com'],
		)
...
def submit_form(C_UniqueID):
	...
	form_docx_path = "reform/GLOW_Form.docx"  # Path to the first document
	e_cert_docx_path = "e-certs/GLOWcertificate2024.docx"  # Path to the second document
